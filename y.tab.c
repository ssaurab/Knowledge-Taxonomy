...
{
  "$end", "error", "$undefined", "AND", "FILLS", "EXISTS", "ALL",
  "CONSTANT", "NAME", "INTEGER", "'['", "']'", "':'", "$accept", "program",
  "concepts", "concept", "role", YY_NULLPTR
};
#endif
...
{
       4,    16,     1,    10,     2,    12,    15,    13,    23,     5,
       6,     7,     8,    17,     9,    18,    24,    21,    22,    25,
      11,    26,     0,    27
};

static const yytype_int8 yycheck[] =
{
       0,     8,     8,     0,    10,     5,     9,    12,    15,     3,
       4,     5,     6,    11,     8,    11,    16,     8,     7,    11,
       5,    11,    -1,    11
};
...
{
       0,     8,    10,    14,    16,     3,     4,     5,     6,     8,
       0,    15,    16,    12,    17,     9,    17,    11,    11,    15,
      16,     8,     7,    17,    16,    11,    11,    11
};
...
#line 1248 "y.tab.c" /* yacc.c:1646  */
  ...
  case 4:
#line 40 "a2.y" /* yacc.c:1646  */
    {
        (yyval) = new Node();
        (yyval)->type=MORECONCEPTS;
        (yyval)->children.push_back((yyvsp[-1]));
        (yyval)->children.push_back((yyvsp[0]));
    }
...
#line 1312 "y.tab.c" /* yacc.c:1646  */
  ...
  case 10:
#line 83 "a2.y" /* yacc.c:1646  */
    {
        (yyval) = new Node();
        (yyval)->type="and";
        (yyval)->name="Concepts";
        vector<Node*> vec;
        makeListConcepts((yyvsp[-1]),vec);
        (yyval)->children=vec;
    }
